...
PREVIEW_IMAGE_ID: int = 6797998
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/makassar-road"
# URL to GitHub repo on dataset ninja (e.g. "https://github.com/dataset-ninja/some-dataset")

##################################
### * Optional after uploading ###
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = ["https://www.kaggle.com/datasets/nublanazqalani/semantic-segmentation-makassaridn-road-dataset"]
...
AUTHORS: Optional[List[str]] = ["Nublan Azqalani"]
AUTHORS_CONTACTS: Optional[List[str]] = ["https://www.kaggle.com/nublanazqalani"]
